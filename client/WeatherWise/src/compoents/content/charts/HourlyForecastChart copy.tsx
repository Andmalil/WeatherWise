...
//         const hourForecastTemps = forecasts[currentCity].hourForecast[0].map( (w)=> w.temp)
//         const ratio = (Math.max(...hourForecastTemps.map(e=>e[currentUnits.temp]))-Math.min(...hourForecastTemps.map(e=>e[currentUnits.temp])))/10
...
//         datasets: [{
//             data: forecasts[currentCity].hourForecast[0].map((w)=>w.temp),
//             fill: false,
...
//                             xMin: 1,
//                             xMax: 1,
//                             yMax: forecasts[currentCity].hourForecast[0][1].temp,
//                             borderColor: '#B6C3CE',
//                             borderWidth: 2,
//                             borderDash: [5]
//                           },
...
//                             type: 'point',
//                             xValue: 1,
//                             yValue: forecasts[currentCity].hourForecast[0][1].temp,
//                             radius: 5,
...
//                           ...tempLabels(forecasts[currentCity].hourForecast[0].map((w)=>w.temp[currentUnits.temp]))
//                         }
//                       }
